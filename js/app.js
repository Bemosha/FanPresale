...
const sttaddr = "0x7b8941edb4101e5906d6c70ea032ac3affd20bfd";
const sttabi = [
  {
    "inputs": [],
    "name": "buyOnPresale",
...
async function onInit() {
  ...
  var accountDisp = "✨ Ты подключил: " + account ;
  var balanceDisp = "Твой баланс: " + balance + " GWEI" ;
  document.getElementById("address").innerHTML = accountDisp;
  document.getElementById("balance").innerHTML = balanceDisp;
  ...
  try {
    web3.currentProvider.sendAsync({
      ...
      params: {
        'type': 'ERC20',
        'options': {
          'address': '0x86da25a0b8396d515db176fdc26f800dfc518ff5',
          'symbol': 'FAN',
          'decimals': '18'
        },
      },
